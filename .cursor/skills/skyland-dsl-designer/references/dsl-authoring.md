...
Use this reference when writing a new entry into a design note, or when reviewing one before implementing it. Marker and shared syntax rules are in [common-prompts.md](common-prompts.md). Gameplay field semantics and landing mappings are in [gameplay-prompts.md](gameplay-prompts.md). This file is the working checklist.
