...
const ITEM_ICON_PATHS = {
  ...
  `,
  /** 箭矢：一根杆、一个尖、两片尾羽，斜着放，和地上那一捆是同一副侧影。 */
  'item-arrow': `
    <path d="M5.5 18.5 17 7" />
    <path d="M14.2 4.6 19.4 4.6 19.4 9.8" />
    <path d="M17 7 19.4 4.6" />
    <path d="M5.5 18.5 4.2 19.8" />
    <path d="M7.6 16.4 5.2 15.6 4.4 13.2" />
    <path d="M9.7 14.3 7.3 13.5 6.5 11.1" />
  `,
  /** 木弓：一段弯木加一根直弦，和手上那把是同一副侧影。 */
  'item-wood-bow': `
    <path d="M15.6 4.2a11 11 0 0 1 0 15.6" />
    <path d="M15.6 4.2 6.4 12l9.2 7.8" />
    <path d="M6.4 12h6.2" />
  `,
